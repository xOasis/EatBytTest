 ...
 */
public class bottom_navigation extends BottomNavigationView {
    // used for animation
...
//        init();
    ...
    public bottom_navigation(Context context, AttributeSet attrs) {
        super(context, attrs);
//        init();
    }

    public bottom_navigation(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        System.out.println("mMenuView:" + mMenuView + " mButtons:" + mButtons + " mOnClickListener" + mOnClickListener);
     ...
     * necessary calls back to the provided {@link bottom_navigation} so that the tab position is
     * kept in sync.
     * <p>
    ...
    private static class BottomNavigationViewExOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<bottom_navigation> mBnveRef;

        public BottomNavigationViewExOnPageChangeListener(bottom_navigation bnve) {
        ...
        public void onPageSelected(final int position) {
            final bottom_navigation bnve = mBnveRef.get();
...
//            Log.d("onPageSelected", "--------- position " + position + " ------------");
    ...
    private static class MyOnNavigationItemSelectedListener implements OnNavigationItemSelectedListener {
        ...
        MyOnNavigationItemSelectedListener(ViewPager viewPager, bottom_navigation bnve, boolean smoothScroll, OnNavigationItemSelectedListener listener) {
